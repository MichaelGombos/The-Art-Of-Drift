  ...
  return (
    <div className={`menu options ${previous == "main" ? "from-main" : null}`}>
      ...
      <div className="settings-wrapper">
        ...
        <ExitSettingsButton isSaving={true} setNewEnableGhost={setNewEnableGhost} setNewParticleLimit={setNewParticleLimit} newEnableGhost={newEnableGhost} newParticleLimit={newParticleLimit} />
      </div>
  </div>
  )
